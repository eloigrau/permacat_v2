...
urlpatterns = [
   ...
   path('ajouterAdresseArticle/<int:id_article>', views.ajouterAdresseArticle, name='ajouterAdresseArticle'),
    ...
    path(r'voir_articles_liens_d3_tree2/<str:asso_abreviation>/',
         views_d3.voir_articles_liens_d3_tree2,
        name='voir_articles_liens_d3_tree2'),
    path(r'voir_articles_liens_d3_tree_indented_dossier/<str:asso_abreviation>/',
    ...
    path(r'voir_articles_liens_d3_tree_indented_projet/<str:asso_abreviation>/',
         views_d3.voir_articles_liens_d3_tree_indented_projet,
        name='voir_articles_liens_d3_tree_indented_projet'),
    path(r'get_articles_asso_d3_hierar_projet/<str:asso_abreviation>/',
