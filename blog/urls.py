...
urlpatterns = [
    ...
    path('projets/detail/<str:slug>/', views.lireProjet, name='lireProjet'),
   ...
   path('ajouterAdresseArticle/<int:id_article>/', views.ajouterAdresseArticle, name='ajouterAdresseArticle'),
    ...
    path('ajax/load-cercles/', views.ajax_cercles, name='ajax_cercles'),
    ...
    path('ajax/ajax_infosArticle/<str:slug_article>/', views.ajax_infosArticle, name='ajax_infosArticle'),
