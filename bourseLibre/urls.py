...
urlpatterns = [
    ...
    re_path('avatar/', include('avatar_local.urls')),
    ...
    re_path(r'^accounts/profil/(?P<user_username>[\w.@+-]+)/$', login_required(views_base.profil_nom), name='profil_nom',),
    re_path(r'^accounts/profile/$',  login_required(views.profil_courant), name='profil_courant',),
    re_path(r'^accounts/profil_inconnu/$', views_base.profil_inconnu, name='profil_inconnu',),
    ...
    re_path(r'^accounts/supprimerAction/(?P<actionid>[0-9]+)/$', login_required(views.supprimerAction), name='supprimerAction',),
    re_path(r'^accounts/mesActions/$', login_required(views.mesActions), name='mesActions',),
    path(r'accounts/mesPublications/<str:type_action>', login_required(views.mesPublications), name='mesPublications',),
    path(r'accounts/ajouterAdhesion/<str:abreviationAsso>', login_required(views_admin.ajouterAdhesion), name='ajouterAdhesion',),
    re_path(r'^accounts/activite/(?P<pseudo>[\w.@+-]+)/$', login_required(views_base.activite), name='activite',),
