...
urlpatterns = [
    ...
    path(r'collectifssa/', include('collectifssa.urls', namespace='collectifssa')),
...
#    path(r'phonebook/', include('phonebook.urls')),
    ...
    re_path(r'^notifications/changerDateNotif/$', views_notifications.changerDateNotif, name='changerDateNotif'),
    ...
    re_path(r'^notifications/dernieresInfos/$', views_notifications.dernieresInfos, name='dernieresInfos'),
    ...
    re_path(r'^contact/merci/$', views.merci, name='merci'),
    ...
    re_path(r'^compte/register/$', views.register, name='senregistrer',),
    re_path(r'^compte/reset-password/$', PasswordResetView.as_view(template_name='accounts/reset_password.html',
    ...
    re_path(r'^compte/password/change/$', views.change_password, name='change_password'),
    path('auth/', include('django.contrib.auth.urls')),

    re_path(r'^contact/contact_admins/$', views.contact_admins, name='contact_admins',),
    re_path(r'^contact/signaler_bug/$', views.signaler_bug, name='signaler_bug',),
