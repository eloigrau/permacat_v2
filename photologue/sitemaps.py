...
.. code-block:: python
    ...
    ...
    from photologue.sitemaps import AlbumSitemap, PhotoSitemap

    sitemaps = {...
                'photologue_galleries': AlbumSitemap,
                'photologue_photos': PhotoSitemap,
                ...
                }
    etc...

There are 2 sitemap classes, as in some cases you may want to have album pages,
...
# Note: Album and Photo are split, because there are use cases for having galleries
