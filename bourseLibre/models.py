...
class Profil(AbstractUser):
    ...
    adherent_pc = models.BooleanField(verbose_name=_("Je suis adhérent-e de Permacat"), default=False)
    adherent_rtg = models.BooleanField(verbose_name=_("Je suis adhérent-e de Ramene Ta Graine"), default=False)
    adherent_fer = models.BooleanField(verbose_name=_("Je suis adhérent-e de Fermille"), default=False)
    #adherent_gt = models.BooleanField(verbose_name=_("Je suis adhérent de Gardiens de la Terre", default=False)
    adherent_scic = models.BooleanField(verbose_name=_("Je suis intéressé-e par le collectif 'PermAgora'"), default=False)
    adherent_citealt = models.BooleanField(verbose_name=_("Je fais parti-e de 'la Cité Altruiste'"), default=False)
    adherent_viure = models.BooleanField(verbose_name=_("Je fais parti-e du collectif 'Viure'"), default=False)
...
class Salon(models.Model):
    ...
    def save(self, asso_slug=None, *args, **kwargs):
        max_length = 99
        if not self.id:
        ...
        if not self.asso and asso_slug:
             self.asso = Asso.objects.get(slug=asso_slug)
