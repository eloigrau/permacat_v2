...
class AdherentForm(forms.ModelForm):
    ...
    production_ape = forms.CharField(label="Production", help_text="Selectionner la production correspondant à votre code APE dans la liste", required=False, widget=forms.Select(choices=list_ape))
