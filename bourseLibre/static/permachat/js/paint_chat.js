...
function redraw_canvas(data_canvas) {
  // Redraw all the shapes on the canvas
  ctx.clearRect(0, 0, canvas.width, canvas.height);
  // Redraw the pencil data
  data_canvas.pencil.forEach(function(p) {
    ctx.beginPath();
  ...
  data_canvas.line.forEach(function(l) {
    ctx.beginPath();
  ...
  data_canvas.rectangle.forEach(function(l) {
        if (l.isStroke){
  ...
  data_canvas.circle.forEach(function(l) {
    ctx.beginPath();
