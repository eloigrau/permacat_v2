...
from local_summernote.utils import get_proper_language, using_config
try:
...
class SummernoteWidget(SummernoteWidgetBase):
    def render(self, name, value, attrs=None, **kwargs):
        ...
        context = {
            ...
            'src': reverse('local_summernote-editor', kwargs={'id': attrs['id']}),
        ...
        html += render_to_string('local_summernote/widget_iframe.html', context)
...
class SummernoteInplaceWidget(SummernoteWidgetBase):
    ...
    def render(self, name, value, attrs=None, **kwargs):
        ...
        html += render_to_string('local_summernote/widget_inplace.html', context)
        return mark_safe(html)
