...
def creer_zones_geo(apps, schema_editor):
    ...
    noms = ["La plaine du Roussillon", "Perpignan", "Les Albères et Côte Vermeille", "Le Conflent", "Le Vallespir", "Le Fenouillèdes",  "Le Ribéral", "Les Aspres", "La Salanque", "Le Capcir", "La Cerdagne",  "Département", "Région", "Catalogne", "Occitanie", "France", "Europe", "Monde", "Univers", "Cosmos"]
    for n in noms:
