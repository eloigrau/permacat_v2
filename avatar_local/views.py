...
from avatar_local.conf import settings
from avatar_local.forms import DeleteAvatarForm, PrimaryAvatarForm, UploadAvatarForm
from avatar_local.models import Avatar
from avatar_local.signals import avatar_deleted, avatar_updated
