            ...
            if (this._status === 'closed') {
                ...
                Chat.Incoming.onfatal = function(code) {
                    if (code === "not-authenticated") {
                        onfatal(code, "Vous n'êtes pas autentifié-e");
                    } else if (code === "already-chatting") {
                        onfatal(code, "Déjà présent");
                    } else if (code === "websocket") {
                        onfatal(code, "websocket error - check your console for more details");
                    }
                };
        ...
        _joinedRoom: function(roomName, stamp, username, you, status) {
            ...
            messages.append(
                $('<div/>').append(
                    ...
                    $('<span class="join" />').text('est entré-e dans la salle')
                )
            );
            ...
            if (you) {
                ...
                messages.append(
                    $('<div/>').append(
                        ...
                        $('<span class="part" />').text('est parti-e')
                    )
                );
                messages.scrollTop(messages.prop("scrollHeight"));
            }
