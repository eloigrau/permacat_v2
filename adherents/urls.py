...
urlpatterns = [
    ...
    path(r'conf66/adherent/adherents_modifier_adresse/<int:adresse_pk>', login_required(views.AdherentAdresseUpdateView.as_view()), name="adherents_modifier_adresse"),
    ...
    path(r'conf66/phoning/projet/liste', views_phoning.ProjetPhoning_liste.as_view(), name="phoning_projet_liste"),
    path(r'conf66/phoning/projet/simple/<str:projet_pk>', login_required(views_phoning.Contact_liste.as_view()), name="phoning_projet_simple"),
    path(r'conf66/phoning/projet/courant/simple', views_phoning.phoning_projet_courant, name="phoning_projet_courant"),
    path(r'conf66/phoning/projet/courant/complet', login_required(views_phoning.Contact_liste.as_view()), name="phoning_projet_complet"),
    #path(r'conf66/phoning/contact_ajouter/', views.creerListeDiffusion, name="listeDiffusion_creer"),
    path(r'conf66/phoning/ajouter/acceuil', views_phoning.contact_ajouter_accueil, name="phoning_contact_outils"),
    path(r'conf66/phoning/projet/courant/ajouter', login_required(views_phoning.Contact_ajouter.as_view()), name="phoning_contact_ajouter"),
    path(r'conf66/phoning/projet/courant/ajouter/listetel', views_phoning.phoning_contact_ajouter_listetel, name="phoning_contact_ajouter_listetel"),
    path(r'conf66/phoning/ajouter/csv', views_phoning.phoning_contact_ajouter_csv, name="phoning_contact_ajouter_csv"),
    path(r'conf66/phoning/ajouter/adherents', views_phoning.ajouterAdherents, name="phoning_ajouterAdherents"),
    ...
    path(r'conf66/phoning/modifier/<int:pk>', login_required(views_phoning.Contact_modifier.as_view()), name="phoning_contact_modifier"),
    path(r'conf66/phoning/supprimer/<int:pk>', login_required(views_phoning.Contact_supprimer.as_view()), name="phoning_contact_supprimer"),
    path(r'conf66/phoning/supprimer2/<int:contact_pk>', views_phoning.contact_supprimer, name="phoning_contact_supprimer2"),
    path(r'conf66/phoning/contact/ajouter/<int:contact_pk>', views_phoning.contactContact_ajouter, name="phoning_contact_contact_ajout"),
    path(r'conf66/phoning/contact/supprimer/<int:contact_contact_pk>', views_phoning.contactContact_supprimer, name="phoning_contact_contact_supprimer"),
    path(r'conf66/phoning/get_csv_contacts/', views_phoning.get_csv_contacts, name="get_csv_contacts"),


    path(r'conf66/phoning/projet/ajouter', login_required(views_phoning.ProjetPhoning_ajouter.as_view()), name="phoning_projet_ajouter"),
    path(r'conf66/phoning/projet/<int:pk>/modifier', login_required(views_phoning.ProjetPhoning_modifier.as_view()), name="phoning_projet_modifier"),
    path(r'conf66/phoning/projet/<int:pk>/supprimer', login_required(views_phoning.ProjetPhoning_supprimer.as_view()), name="phoning_projet_supprimer"),
]
