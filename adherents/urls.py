...
urlpatterns = [
    ...
    path(r'<str:asso_slug>/adherents/ajouter/', views.adherent_ajouter, name="adherent_ajouter"),
    path(r'<str:asso_slug>/adherents/ajouterLesMembresGroupe/', views.ajouterLesMembresGroupe, name="ajouterLesMembresGroupe"),
    path(r'<str:asso_slug>/adherents/detail/<int:pk>', login_required(views.AdherentDetailView.as_view()), name="adherent_detail"),
    path(r'<str:asso_slug>/adherents/monProfil', views.monProfil, name="monProfil"),
    path(r'<str:asso_slug>/adherents/modifier/<int:pk>', login_required(views.AdherentUpdateView.as_view()), name="adherent_modifier"),
    path(r'<str:asso_slug>/adherents/adherents_modifier_adresse/<int:pk>', login_required(views.AdherentAdresseUpdateView.as_view()), name="adherents_modifier_adresse"),
    path(r'<str:asso_slug>/adherents/supprimer/<int:pk>', login_required(views.AdherentDeleteView.as_view()), name="adherent_supprimer"),
