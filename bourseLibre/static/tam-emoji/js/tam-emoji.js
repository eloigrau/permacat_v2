        ...
        'emoji': function (context) {
            ...
            var addListener = function () {
                ...
                $(document).on('click', '.' + editorId + ' .emoji-items a', function(){
                    var emoji = $('.label_emoji', $(this)).text();
                    ...
                    $.each(self.icons, function (key, icon) {
                        if (self.icons.hasOwnProperty(key)
                            ...
                            $items.append('<a href="javascript:void(0)" title="'
                                ...
                                + '<span class="label_emoji">' + Config.htmlEntities(key)
                                + '</span></a>');
                        }
                    });
                }else{
            ...
            var createdEmojiIcon = function(emoji){
                ...
                var filename =  '/static/tam-emoji/img/emoji_spritesheet_!.png';
                var blankGifPath = '/static/tam-emoji/img/blank.gif';
            ...
            context.memo('button.emoji', function () {
                ...
                var button = ui.button({
                    contents: '<img src="/static/tam-emoji/img/blank.gif" class="img" '+
                        'style="display:inline-block;width:25px;height:25px;'+
                        "background:url('/static/tam-emoji/img/emoji_spritesheet_0.png') -25px 0px no-repeat;background-size:675px 175px;" +
                        'alt=":smiley:">',
                    click: function () {
